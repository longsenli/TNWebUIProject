...
function tidyBatteryRecordProductionProcessSlctFun() {
	$.ajax({
		url: "http://10.0.0.151:19001/ilpsService/api/basicdata/getproductionprocess",
		type: "GET",
...
function tidyBatteryRecordProductionLineSlctFun() {
	...
	$.ajax({
		url: "http://10.0.0.151:19001/ilpsService/api/basicdata/getproductionline",
		type: "POST",
		data: formData,
		//contentType: "application/json",
		//dataType: "json",
...
function tidyBatteryRecordWorkingLocationSlctFun() {
	...
	$.ajax({
		url: "http://10.0.0.151:19001/ilpsService/api/basicdata/getworklocation",
		type: "POST",
		data: formData,
		//contentType: "application/json",
		//dataType: "json",
...
function getTidyRecord(selectType) {
	...
	$.ajax({
		url: "http://10.0.0.151:19001/ilpsService/api/chargepack/gettidybatteryrecord",
		type: "POST",
		data: formData,
		processData: false,
		contentType: false,
...
function getPileRecord(selectType) {
	...
	$.ajax({
		url: "http://10.0.0.151:19001/ilpsService/api/chargepack/getpiletidybatteryrecord",
		type: "POST",
		data: formData,
		processData: false,
		contentType: false,
...
function saveTidyBatteryRecordModel(modelID, formID) {
	...
	$.ajax({
		url: "http://10.0.0.151:19001/ilpsService/api/chargepack/changetidybatteryrecord",
		type: "POST",
		contentType: "application/json",
		dataType: "json",
...
function pileTidyBatteryRecord() {
	...
	$.ajax({
		url: "http://10.0.0.151:19001/ilpsService/api/chargepack/addpiletidybatteryrecord",
		type: "POST",
		data: formData,
		processData: false,
		contentType: false,
